        ...
        <>
            ...
            <Row className={globalStyles.comm_main} type="flex" justify="center">
                <Col className={globalStyles.comm_left} xs={24} sm={24} md={16} lg={18} xl={14}  >
                    <div>
                        <div className={globalStyles.bread_div}>
                            <Breadcrumb>
                        ...
                        <List
                            ...
                            renderItem={item => (
                                <List.Item>
                                    ...
                                    <div className={styles.list_context}>{item.article_brief}</div>
                                </List.Item>
                            )}
                        />
                    </div>
                ...
                <Col className={globalStyles.comm_right} xs={0} sm={0} md={7} lg={5} xl={4}>
                    <Author />
                    {/*<Advert />*/}
                </Col>
            </Row>
